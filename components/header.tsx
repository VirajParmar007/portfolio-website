  ...
  return (
    <header className="z-[999] relative">
      ...
      <nav className="flex fixed top-[0.15rem] left-1/2 -translate-x-1/2 h-12 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
        <ul className="flex flex-wrap items-center justify-center w-[22rem] gap-y-1 font-medium text-[0.9rem] text-gray-500 sm:flex-nowrap sm:gap-5">
          {links?.map((link) => (
            <motion.li
            ...
            >
              <Link
                className={`flex w-full justify-center items-center p-3 hover:text-gray-950 transition dark:text-gray-500 dark:hover:text-gray-300 ${
